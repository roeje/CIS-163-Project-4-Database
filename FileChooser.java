/**
 * FileChooser provides a dialog window with which the user can select a file.
 * 
 * @author (your name) 
 * @version (10-20-2014)
 */
...
public class FileChooser
{
    ...
    public static void main( )
    {
        ...
        inputFileName   = textFile.chooseFile( "open" ,"contact list" );
        outputFileName  = textFile.chooseFile( "save" ,"contact list" );
